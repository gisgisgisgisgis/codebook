...
\includecode{Enumerate Planar Face [10dc9a]}{../code/Graph/EnumeratePlanarFace.cpp}
...
\includecode{Tree Hash [46882e]}{../code/Graph/TreeHash.cpp}
...
\includecode{SA-IS [2a7f73, 06a2fa]}{../code/String/SAIS.cpp}
